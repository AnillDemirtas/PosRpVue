...
import { subeye_gore_satilan_urun_gruplar_detayi } from "@/query/satilan_urunler";
export default {
  components: { Datatables },
  props: { modal: null, sube_id: null, grup_id: null },

  watch: {
    async modal() {
      this.gelen_data = await subeye_gore_satilan_urun_gruplar_detayi(
        this.sube_id,
        this.grup_id
      );
    },
